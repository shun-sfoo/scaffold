 ...
 public:
  ...
  void run() {
    try {
      for (;;) {
        incoming.wait()
            .handle<issue_money, std::function<void(issue_money const& msg)>, messaging::dispatcher>(
            ...
            .handle<display_enter_pin, std::function<void(display_enter_pin const& msg)>>(
                ...
                "display_enter_pin")
            .handle<display_enter_card, std::function<void(display_enter_card const& msg)>>(
                ...
                "display_enter_card")
            .handle<display_balance, std::function<void(display_balance const& msg)>>(
                ...
                "display_balance")
            .handle<display_withdrawal_options, std::function<void(display_withdrawal_options const& msg)>>(
            ...
            .handle<display_withdrawal_cancelled, std::function<void(display_withdrawal_cancelled const& msg)>>(
            ...
            .handle<display_pin_incorrect_message, std::function<void(display_pin_incorrect_message const& msg)>>(
